  ...
  <>
    <div css={styles.element}>
      <div css={styles.container}>
        ...
        <Route
          ...
          render={() => (
            <div css={styles.secondary}>
              ...
              <NavLink to="/movies/discover" exact={true} activeStyle={styles.active}>Discover</NavLink>
        ...
        />
        <NavLink to="/series" activeStyle={styles.active}>Series</NavLink>
        <Route
          path="/series"
          render={() => (
            <div css={styles.secondary}>
              ...
              <NavLink to="/series/library" exact={true} activeStyle={styles.active}>Library</NavLink>
              <NavLink to="/series/discover" exact={true} activeStyle={styles.active}>Discover</NavLink>
              <NavLink to="/series/calendar" activeStyle={styles.active}>Calendar</NavLink>
            </div>
          )}
        />
        <NavLink to="/persons/following" activeStyle={styles.active}>Stars</NavLink>
        <Route
          path="/persons"
          render={() => (
            <div css={styles.secondary}>
              ...
              <NavLink to="/persons/following" exact={true} activeStyle={styles.active}>Following</NavLink>
            </div>
          )}
        />
